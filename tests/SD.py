...
def test_check_time_of_escalation(driver):
    ...
    name = 'ПАНТЮХОВ ГЕОРГИЙ (PANTYUKHOV.GS)'
    number = '0000'
    service = 'Тестовый ЕМИАС(CI9954462)'
    description1 = 'Тест'
    description2 = 'Тест test test'
    ...
    #page.click_create_SD_tool_tip()
    #Шаг 5: "Выбрать категорию Запрос на обслуживание"
    page.choose_needful_category_sd()
    #Шаг 6: "Заполнить карточку регистрации Обращения"
    page.fill_form_SD(initiator, name, number, service, description1, description2, request, employee)
